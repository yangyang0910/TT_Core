...
<div class="sui-container">
    ...
    <div class="sui-content">
                ...
                <?php foreach ($svrInfo['net'] as $key => $value) { ?>
                    <tr>
                        ...
                        <td class="text-center"><span
                                    id="<?php echo $value['name']; ?>_errors"><?php echo $value['errors']; ?></span> /
                            <span id="<?php echo $value['name']; ?>_drops"><?php echo $value['drops']; ?></span></td>
                    </tr>
                <?php } ?>
                </tbody>
            </table>
        ...
        <table class="sui-table table-bordered table-primary">
            ...
            <tr>
                <td width="20%">参照对象</td>
                <td class="text-center">整数运算能力测试
                    <div class="stxt">(1+1运算300万次)</div>
                </td>
                <td class="text-center">浮点运算能力测试
                    <div class="stxt">(圆周率开平方300万次)</div>
                </td>
                <td class="text-center">数据I/O能力测试
                    <div class="stxt">(读取10K文件1万次)</div>
                </td>
            ...
            <tr>
                ...
                <td class="text-center">
                    <button type="button" data-loading-text="测试中..." id="btnTest" class="sui-btn btn-large btn-primary"
                            autocomplete="off"><-- 开始测试
                    </button>
                </td>
            </tr>
            </tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center test-td">
                                    <div class="input-prepend input-append">
                                        ...
                                        <input class="input-xfat input-large" id="inputHost" name="host"
                                               value="localhost" placeholder="主机" type="text">
                                        <span class="add-on">端口</span>
                                        <input class="input-xfat input-large" id="inputPort" name="port" value="3306"
                                               placeholder="端口" type="text">
                                        <span class="add-on">用户名</span>
                                        <input class="input-xfat input-large" id="inputUser" name="user"
                                               placeholder="用户名" type="text">
                                        <span class="add-on">密码</span>
                                        <input class="input-xfat input-large" id="inputPwd" name="pwd" placeholder="密码"
                                               type="text">
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <button type="submit" data-loading-text="检测中..."
                                                    class="sui-btn btn-large btn-primary">检 测
                                            </button>
                                        </div>
                                    </div>
                                </td>
                        ...
                        <table class="sui-table test-table">
                            <tr>
                                ...
                                <td class="text-center test-td">
                                    <div class="control-group">
                                        <div class="controls">
                                            <input name="funname" placeholder="请输入您要检测的函数名,例如 'explode' "
                                                   class="input-xfat input-xxlarge" type="text">
                                        </div>
                                    </div>
                                </td>
                                <td class="text-center">
